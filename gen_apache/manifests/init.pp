...
define gen_apache::forward_vhost($ensure="present", $forward, $address = '*', $address6 = '::', $port=80, $serveralias=false, $statuscode=301, $condpattern=false, $teststring="%{HTTP_HOST}", $preserve_path=true, $access_logformat='combined') {
